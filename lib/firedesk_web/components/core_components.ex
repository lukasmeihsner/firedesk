defmodule FiredeskWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FiredeskWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FiredeskWeb.Gettext, "errors", msg, opts)
    end
  end
